...
@CucumberOptions (
		features = "src/test/resources/features/AddEmployeeEmergnecyContact.feature", //specify which feature file to run
...
//mvn test -Dcucumber.options="--tags @mvn" common will run from terminal 
